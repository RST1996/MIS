...
if( isset($_GET['id']) && (isLogin() != null) )
{
		...
		$data_query = "SELECT  `academic_year`.`academic_year` ,  `course`.`course_code` ,  `course`.`course_name` ,  `course`.`credits` ,  `course_assign`.`sem` ,  `course_assign`.`branch` , `th_mks_scheme`.`ise2` ,  `department`.`department_name` ,  `exam_session`.`session`,`year2sem_relation`.`year`
		...
		$fileName = 'R02 ' . $row2['course_code'] . '.pdf';
