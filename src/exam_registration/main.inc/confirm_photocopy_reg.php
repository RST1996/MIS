	...
	if (isset($_POST['save'])) {
		...
		else
		{
			...
			$N = count($test);
						...
						{
							$id=$test[$i];
							$assign = conform_photocopy_reg($id);
						...
						if ($assign == "success") {
							...
							<?php
							unset($_POST);
							header( "refresh:10; url=confirm_photocopy_reg.php" );
						}
						else 
						{
				?>
	...
	<div class="row clearfix">	
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
							CONFIRM PHOTOCOPY REGISTRATION
							</h2>                            
                        </div>
                        <div class="body">
							<form method = "POST" action = "confirm_photocopy_reg.php">
                                <fieldset>
			...
			<script type="text/javascript">
				function show_list()
				{
					...
					xhttp.open("POST", "../config/ajax/confirm_photocopy_reg.php", true);
