		...
		else
		{
			...
			$N = count($test);
						...
						if ($assign == "success") {
							...
							<?php
							unset($_POST);
							header( "refresh:10; url=confirm_internal_cancellation.php" );
						}
						else 
						{
				?>
	...
	<div class="row clearfix">	
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
							CONFIRM REVAL REGISTRATION
							</h2>                            
                        </div>
                        <div class="body">
							<form method = "POST" action = "confirm_internal_cancellation.php">
                                <fieldset>
			...
			<script type="text/javascript">
				function show_list()
				{
					...
					xhttp.open("POST", "../config/ajax/confirm_internal_cancellation.php", true);
