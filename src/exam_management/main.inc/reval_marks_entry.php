...
<?php
			header( "refresh:1; url=reval_marks_entry.php" );
		}
	}
    if(isset($_POST['marks_list']))
    {
        ...
        $result = reval_marks_entry($stud_list,$course_id,$marks_list);
        if($result == "success")
        {
	   ...
	   <div class="row clearfix">	
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
						<form method = "POST" action = "reval_marks_entry.php">
                            <fieldset>
<?php
    //var_dump($activity);
...
<script type="text/javascript">
    function show_stud_list()
    {
        ...
        if (exam_id != null && course != null && dept != null) 
        {
            ...
            xhttp.open("POST", "../config/ajax/reval_marks_entry.php", true);
            xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
<script type="text/javascript">
    function update_marks(input_id,id)
    {
        ...
        if(mark <= max_marks && mark >= 0)
        {
            ...
            xhttp.open("POST", "../config/ajax/update_reval_marks.php", true);
            xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
<script type="text/javascript">
	function finalize()
	{
        ...
        xhttp.open("POST", "../config/ajax/finalize_reval_ese_marks.php", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
