                         ...
                         <div class="row clearfix">
										...
										<div class="col-md-6">
												<select class="form-control show-tick" id="department" data-live-search="true" name="department" onchange="show_list()"required>
													...
													<?php
														$dep_sel_query = "SELECT `id`, `department_name` FROM `department` WHERE `id` <> 8";
...
function show_list()
{
        ...
        xhttp.open("POST", "../config/ajax/view_course_teacher.php", true);
...
<script type="text/javascript">
	function enable_edit(branch, course, ip_id, btn_id )
	{
        ...
        xhttp.open("POST", "../config/ajax/manage_course_teacher.php", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
<script type="text/javascript">
	function save(branch,course,source_id)
	{
		...
		if (teacher) {
	        ...
	        xhttp.open("POST", "../config/ajax/manage_course_teacher2.php", true);
	        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
